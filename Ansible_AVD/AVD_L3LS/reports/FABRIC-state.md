...
| --- | ----------- | ------------ | ------------ | ----------------- |
| leaf1 |  57 | 49 | 8 | Interface State, MLAG, BGP, Routing Table, Loopback0 Reachability |
| leaf2 |  57 | 50 | 7 | Interface State, MLAG, BGP, Routing Table, Loopback0 Reachability |
| leaf3 |  57 | 49 | 8 | Interface State, MLAG, BGP, Routing Table, Loopback0 Reachability |
| leaf4 |  58 | 51 | 7 | Interface State, MLAG, BGP, Routing Table, Loopback0 Reachability |
| spine1 |  23 | 23 | 0 | - |
| spine2 |  23 | 23 | 0 | - |
| spine3 |  23 | 23 | 0 | - |
| spine4 |  23 | 23 | 0 | - |
...
| ------- | ---- | ------------- | ---------------- | ---- | ----------- | -------------- |
| 54 | leaf1 | Interface State | Port-Channel Interface & Line Protocol == "up" | Port-Channel1 - MLAG_PEER_leaf2_Po1 | FAIL | Interface shutdown: False - interface status: down - line protocol status: lowerLayerDown |
...
| 56 | leaf2 | Interface State | Port-Channel Interface & Line Protocol == "up" | Port-Channel1 - MLAG_PEER_leaf1_Po1 | FAIL | Interface shutdown: False - interface status: down - line protocol status: lowerLayerDown |
| 58 | leaf3 | Interface State | Port-Channel Interface & Line Protocol == "up" | Port-Channel1 - MLAG_PEER_leaf4_Po1 | FAIL | Interface shutdown: False - interface status: down - line protocol status: lowerLayerDown |
| 59 | leaf3 | Interface State | Port-Channel Interface & Line Protocol == "up" | Port-Channel7 - host2_PortChannel host3 | FAIL | Interface shutdown: False - interface status: down - line protocol status: lowerLayerDown |
| 60 | leaf4 | Interface State | Port-Channel Interface & Line Protocol == "up" | Port-Channel1 - MLAG_PEER_leaf3_Po1 | FAIL | Interface shutdown: False - interface status: down - line protocol status: lowerLayerDown |
| 62 | leaf1 | Interface State | Vlan Interface & Line Protocol == "up" | Vlan4093 - MLAG_PEER_L3_PEERING | FAIL | Interface shutdown: False - interface status: down - line protocol status: lowerLayerDown |
| 66 | leaf1 | Interface State | Vlan Interface & Line Protocol == "up" | Vlan3009 - MLAG_PEER_L3_iBGP: vrf VRF_A | FAIL | Interface shutdown: False - interface status: down - line protocol status: lowerLayerDown |
| 67 | leaf2 | Interface State | Vlan Interface & Line Protocol == "up" | Vlan4093 - MLAG_PEER_L3_PEERING | FAIL | Interface shutdown: False - interface status: down - line protocol status: lowerLayerDown |
| 71 | leaf2 | Interface State | Vlan Interface & Line Protocol == "up" | Vlan3009 - MLAG_PEER_L3_iBGP: vrf VRF_A | FAIL | Interface shutdown: False - interface status: down - line protocol status: lowerLayerDown |
| 72 | leaf3 | Interface State | Vlan Interface & Line Protocol == "up" | Vlan4093 - MLAG_PEER_L3_PEERING | FAIL | Interface shutdown: False - interface status: down - line protocol status: lowerLayerDown |
| 76 | leaf3 | Interface State | Vlan Interface & Line Protocol == "up" | Vlan3009 - MLAG_PEER_L3_iBGP: vrf VRF_A | FAIL | Interface shutdown: False - interface status: down - line protocol status: lowerLayerDown |
| 77 | leaf4 | Interface State | Vlan Interface & Line Protocol == "up" | Vlan4093 - MLAG_PEER_L3_PEERING | FAIL | Interface shutdown: False - interface status: down - line protocol status: lowerLayerDown |
| 81 | leaf4 | Interface State | Vlan Interface & Line Protocol == "up" | Vlan3009 - MLAG_PEER_L3_iBGP: vrf VRF_A | FAIL | Interface shutdown: False - interface status: down - line protocol status: lowerLayerDown |
| 138 | leaf1 | MLAG | MLAG State active & Status connected | MLAG | FAIL | State: inactive - Negotiation_status: connecting |
| 139 | leaf2 | MLAG | MLAG State active & Status connected | MLAG | FAIL | State: inactive - Negotiation_status: connecting |
| 140 | leaf3 | MLAG | MLAG State active & Status connected | MLAG | FAIL | State: inactive - Negotiation_status: connecting |
| 141 | leaf4 | MLAG | MLAG State active & Status connected | MLAG | FAIL | State: inactive - Negotiation_status: connecting |
| 182 | leaf1 | BGP | ip bgp peer state established (ipv4) | bgp_neighbor: 10.255.251.1 | FAIL | Session state Active |
| 187 | leaf2 | BGP | ip bgp peer state established (ipv4) | bgp_neighbor: 10.255.251.0 | FAIL | Session state Active |
| 192 | leaf3 | BGP | ip bgp peer state established (ipv4) | bgp_neighbor: 10.255.251.5 | FAIL | Session state Active |
| 197 | leaf4 | BGP | ip bgp peer state established (ipv4) | bgp_neighbor: 10.255.251.4 | FAIL | Session state Active |
| 259 | leaf1 | Routing Table | Remote Lo0 address | 192.168.101.2 | FAIL | Lo0 192.168.101.2 is not in the routing table |
| 266 | leaf2 | Routing Table | Remote Lo0 address | 192.168.101.1 | FAIL | Lo0 192.168.101.1 is not in the routing table |
| 277 | leaf3 | Routing Table | Remote Lo0 address | 192.168.101.4 | FAIL | Lo0 192.168.101.4 is not in the routing table |
| 284 | leaf4 | Routing Table | Remote Lo0 address | 192.168.101.3 | FAIL | Lo0 192.168.101.3 is not in the routing table |
| 291 | leaf1 | Loopback0 Reachability | Loopback0 Reachability | Source: leaf1 - 192.168.101.1 Destination: 192.168.101.2 | FAIL | 100% packet loss |
| 298 | leaf2 | Loopback0 Reachability | Loopback0 Reachability | Source: leaf2 - 192.168.101.2 Destination: 192.168.101.1 | FAIL | 100% packet loss |
| 309 | leaf3 | Loopback0 Reachability | Loopback0 Reachability | Source: leaf3 - 192.168.101.3 Destination: 192.168.101.4 | FAIL | 100% packet loss |
| 316 | leaf4 | Loopback0 Reachability | Loopback0 Reachability | Source: leaf4 - 192.168.101.4 Destination: 192.168.101.3 | FAIL | 100% packet loss |
